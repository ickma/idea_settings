...
from wechat_manage.views.menu_manage import menu_add, menu_edit, sync_menus, menu_push

from wechat_manage.views.followers_manage import sync_followers, user_index, followers_group, followers_message
...
urlpatterns = [
    ...
    url(r'menu/push$', menu_push, name=u'推送菜单'),
    ...
    url(r'followers/message', followers_message, name=u'粉丝聊天'),
    url(r'followers/group', followers_group, name=u'粉丝分组'),
