...
(/** @lends <global> */function( $ ) {
	 ...
	 * - hence the @name templatetags in each doc comment. This allows a Javascript function
	...
	DataTable.defaults.column = {
		 ...
		 * HTML templatetags before ordering)) are currently available. Note that only date
	...
	DataTable.ext = _ext = {
		...
		type: {
			 ...
			 * templatetags or to de-format telephone numbers for numeric only searching.
			 *
