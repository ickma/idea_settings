...
class Present(models.Model):
    ...
    status = models.BooleanField(verbose_name=u'是否已领取')
    receiver_follower = models.ForeignKey(verbose_name=u'领取人', to=PublicFollowers)
    received_time = models.DateTimeField(verbose_name=u'领取时间')
